...
urlpatterns = [
    ...
    path('report/<int:pk>/download_file/<path:filetype>/', views.DownloadFileView.as_view(),
    ...
    path('api/report/<int:pk>/download_file/<path:filetype>/', views.DownloadFileView.as_view(),
            name="report_download_file"),
